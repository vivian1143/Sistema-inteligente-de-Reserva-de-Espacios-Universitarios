...
El sistema contará con una plataforma web donde los estudiantes podrán consultar la disponibilidad de los espacios y realizar reservas.
Como elemento diferencial, se incorporará un asistente conversacional basado en inteligencia artificial, similar al funcionamiento de los chatbots utilizados en plataformas como Rappi.
El usuario podrá realizar solicitudes utilizando lenguaje natural, por ejemplo:
...
El backend consulta la base de datos y devuelve los resultados.
IA:
"Encontré dos espacios disponibles. ¿Cuál deseas reservar?"
Una vez el estudiante confirma, el sistema registra la reserva y el servicio de notificaciones envía automáticamente un correo de confirmación.
...
Servicio Web: encargado de la interfaz, autenticación, gestión de reservas, comunicación con la base de datos y conexión con la IA.
Servicio de Notificaciones: encargado de enviar correos automáticos relacionados con las reservas.
...
Esto permitirá demostrar conceptos de microservicios, infraestructura en la nube, seguridad, escalabilidad y automatización.
